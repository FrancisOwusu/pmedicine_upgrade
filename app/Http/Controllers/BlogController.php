...
class BlogController extends Controller
{
    ...
    public function create()
    {
        ...
        //return view
        return view('backend.blog.add-blog-post',compact('categories'));
    }
    ...
    public function blogCategories(){
        ...
        return view('frontend.blog.blog-category',['data'=>$data]);
    }

      public function blogByCategories($category){
        $blogs = Blog::where('cat_id',$category)->orderBy('created_at')->paginate(30);
        if(!Auth::check()){
    ...
    public function edit($id)
    {
        ...
        $categories = categoty::all();
        if ($data) {
            return view('backend.blog.blog-edit', compact('data','categories'));
        }else{
            return abort(404);
        }
