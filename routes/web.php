...
Route::get('pass', function () {
   /* return storage_path('app/public/course');
    return $c_directtory = getcwd();
    $user = \Illuminate\Support\Facades\Auth::user();
    // $user = getPermissionsViaRoles();
    return $user->getPermissionsViaRoles();
    $role = \Spatie\Permission\Models\Role::where("id", $user->role)->first();
    $permssions = \Spatie\Permission\Models\Permission::all();
    $pers = [];
    foreach ($permssions as $p) {
        $pers[] = $p->name;
    }
    return $role->syncPermissions($pers);*/
...
Route::get('/notes-bank/details/{ID}', "BlogController@details")->name('blogDetails');
Route::get('/plab-news/details/{ID}', "NewsController@details")->name('newsDetails');
Route::get('/notes-bank/all', "BlogController@blog_posts")->name('allBlogPosts');
...
//Note bank routes
Route::get('/notes-bank/categories', 'BlogController@blogCategories')->name('blogCategories');
Route::get('/notes-bank/{id}/all', 'BlogController@blogByCategories')->name('blogByCategories');
...
Route::get('courses','FrontendCourseController@Index')->name('courses.page');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('i-bank/smart-mock', "RecallExamController@Index");
    Route::get('i-bank/smart-mock/{id}', "RevisionController@ReExam");
...
//    Route::post('admin/sub-category/update/{id}',"AdminSubctegoryController@Update");
    ...
    //blog posts
    Route::resource('admin/ui/notes-bank', 'BlogController');
...
//{
    Route::get('event', 'EventController@getEvents')->name('getEvents');
    Route::get('event-detail/{id}', 'EventController@getEventDetail')->name('getEventDetail');

Route::get('plab-course', 'PlabCourseController@getPlabCourses')->name('getCourses');
    // Route::get('plab-courses', 'PlabCourseController@getPlabCourses')->name('getCourses');
