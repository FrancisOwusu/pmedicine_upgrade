                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="user_type" class="form-control @error('user_type') is-invalid @enderror" name="user_type" value="{{ old('user_type') }}" autocomplete="country">
                            ...
                            <div class="form-group mb-0">
                                <div class="">
                                    ...
                                    <div class="mt-4 text-center">
                                        <span>Already have an account? <a href="{{ route('login') }}"><b>LOGIN</b></a></span>
                                    </div>
                                </div>
                            </div>
                        </form>
