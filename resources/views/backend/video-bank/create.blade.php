...
@section('content')
    ...
    <div class="alert alert-info" role="alert">Create New Video</div>
    @include('msg.msg')

    <form class="custom_form" action="{{ route('video-bank.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <br>
        <input type="submit" class="btn btn_custom_style btn-primary" value="CREATE NEW VIDEO" style="float:right">
    </form>
