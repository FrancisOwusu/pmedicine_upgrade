    ...
    <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                 <li class="breadcrumb-item" aria-current="page"><a href="{{url('/q-bank/mock-exam/random-mock')}}">Random Mock</a></li>
                  <li class="breadcrumb-item active" aria-current="page"><a href="#">Mock Exam</a></li>
            </ol>
        </nav>
    ...
    <script>
        ...
        function startTimer(duration, display) {
            ...
            var Interval = setInterval(function () {
                var hours = parseInt(timer / (60 * 60));
        ...
        function startOneMinuteTimer(duration, display) {
            var one_minute_timer = duration;
            var Interval1 = setInterval(function () {
                var hours = parseInt(one_minute_timer / (60 * 60));
                var minutes = parseInt( (one_minute_timer/60)%60 , 10);
                var seconds = parseInt( one_minute_timer % 60 , 10);
