    ...
    <div class="container">
           <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="{{url('/our-team/faq')}}">FAQ</a></li>
            </ol>
        </nav>
        
    </div>
        <div class="container  bg-gray" style="padding-left: 20px; padding-right: 20px" id="accordion-style-1">
