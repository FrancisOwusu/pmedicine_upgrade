                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-item">
                                <div class="single-item-image overlay-effect">
                                    <a href="{{route('getCourseDetail', $course->id)}}">
                                        
                                        
                                        <img src="{{storage_path('app/public/plab-courses/'.$course->image)}}" alt="">
                                        <img src="{{asset('/plab-courses/'.$course->image)}}" alt="">
                                      
                                        <img src="{{url('storage/plab-courses/'.$course->image)}}" alt=""></a>
                            ...
                            <div class="col-lg-4  col-md-6 col-12">
                                ...
                                <div class="single-our-blog mt--30">
                                    <div class="our-blog-image">
                                        <a href="#">
                                            <img src="{{ asset('blog/'.$blog->featured_img) }}" alt="">
                                            
                                            
                                            
                                            <img src="{{ url('blog/'.$blog->featured_img) }}" alt=""></a>
                                ...
                                <img src="{{ url('frontend/images/icon/our-blog-01.png') }}" alt="">
                                    ...
                                    <div class="our-blog-contnet">
                                        ...
                                        <div class="text-justify">
                                            <?php echo \Illuminate\Support\Str::limit($blog->description, 110); ?>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-event-item event-style-2">
                                ...
                                <div class="single-event-text">
                                    ...
                                    <p>{!! \Illuminate\Support\Str::limit($event->description, 80) !!}</p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-event-item event-style-2">
                                ...
                                <div class="single-event-text">
                                    ...
                                    <p>{!! \Illuminate\Support\Str::limit($webinar->description, 80) !!}</p>
