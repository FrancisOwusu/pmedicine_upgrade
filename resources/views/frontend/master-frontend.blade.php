                                    ...
                                    <ul>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                @if (Auth::check())
                                                    @if (Auth::user()->role >= '2' && Auth::user()->expeir_date >= date('Y-m-d'))
                                                        ...
                                                        @else
                                                            <li>You do not have permission to access this feature.</li>
                                                        @endif
                                                @endif
                                            </ul>
                                        </li>
                                        ...
                                        <li><a><i class="zmdi zmdi-storage"></i> I-BANK</a>
                                            <ul class="sub-menu">
                                                ...
                                                @if (Auth::check())
                                                    @if (Auth::user()->role >= '2' && Auth::user()->expeir_date >= date('Y-m-d'))
                                                        <li><a href="{{ route('blogCategories') }}"> Notes Bank</a></li>
                ...
                <div class="col-md-4 col-12 mb-md-0 mb-4">
                    <div class="footer-single-block text-center">
                        <div class="footer-logo">
                            <a href="{{url('/')}}"><img src="{{ url('frontend/images/logo/Asset 5@4x.png') }}" alt=""></a>
                        </div>
                    </div>
                </div>
