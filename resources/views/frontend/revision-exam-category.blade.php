...
@php $cat = \App\categoty::where('id',$id)->first();@endphp
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                 <li class="breadcrumb-item" aria-current="page"><a href="{{url('/q-bank/revision-category')}}">Specialities</a></li>
                <li class="breadcrumb-item" aria-current="page">{{($cat)?$cat->name:""}}</li>
