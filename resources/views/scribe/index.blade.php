...
<head>
    ...
    <title>Prepare Medicine API Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "https://preparemedicine.co.uk/";
        var useCsrf = Boolean();
...
<div class="bash-example">
    ...
    "https://preparemedicine.co.uk/api/v1/register" \
...
<p>Example: <code>application/json</code></p>
        ...
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>f_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="f_name"                data-endpoint="POSTapi-v1-register"
               value="b"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="s_name"                data-endpoint="POSTapi-v1-register"
               value="n"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="school"                data-endpoint="POSTapi-v1-register"
               value="h"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "https://preparemedicine.co.uk/api/v1/login" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
